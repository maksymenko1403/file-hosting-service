<x-app>
    ...
    <div class="container col-md-4 col-md-offset-4">
            <div class="form-group mt-4">
                ...
                <input type="file" class="form-control" id="file_path" name="file_path" value="{{$file->file_path}}"/>
            </div>
            ...
            <div class="form-group mt-4">
                ...
                <textarea class="form-control" id="description" name="description" rows="7">{{$file->description}}</textarea>
            </div>
            <x-input-error name="description"></x-input-error>

            <span class="display-6">Visibility</span>
            <div class="form-check mt-2">
                <input class="form-check-input" type="radio" name="is_private" id="public" value="0" required
                       @if($file->is_private  == 0) checked @endif>
            ...
            <div class="form-check">
                ...
                @if($file->is_private == 1) checked @endif>
